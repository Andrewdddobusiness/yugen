      ...
      <Placemark>
        ...
        ${
          location.coordinates
            ? `
        <Point>
          <coordinates>${location.coordinates[0]},${location.coordinates[1]}</coordinates>
        </Point>`
            : ""
        }
        ${
...
export const downloadKML = (kmlContent: string, fileName: string) => {
  ...
  link.href = url;
  const resolvedFileName = fileName.toLowerCase().endsWith(".kml") ? fileName : `${fileName}.kml`;
