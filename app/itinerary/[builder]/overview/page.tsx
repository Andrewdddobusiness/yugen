    ...
    <div>
      <BuilderLayout title="Overview" activePage="overview" itineraryNumber={1}>
        <div className="p-4 h-1/4 relative">
          ...
          />
          <div className="absolute bottom-6 left-12 transform -translate-y-1/2 text-white text-5xl font-bold">
            Bali
          </div>
          <div className="absolute bottom-8 left-[50px] transform -translate-y-1/2 text-white text-lg font-bold">
            Indonesia
          </div>
        </div>
        <div className="flex flex-row">
          ...
          <div className="px-4 w-1/4">
            <div className="col-span-1 text-xs text-black flex justify-center">
              Emergency Numbers
            </div>
            <div className="col-span-1 text-sm text-black flex justify-left mt-2">
              Ubud, Bali is a vibrant and exciting destination for tourists.
              Known for its stunning rice terraces, ancient temples, and rich
              cultural heritage, Ubud offers visitors a unique and unforgettable
              experience. From exploring local markets to indulging in
              traditional Balinese cuisine, there is something for everyone in
